    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-teal-50">
      ...
      <div className="container mx-auto px-4 pt-8">
        <div className="text-center mb-8">
          <span className="inline-flex items-center px-3 py-1 mb-4 rounded-full bg-teal-100 text-teal-800 text-xs font-semibold">
            ...
            <div className=" w-2xl">
              <div className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm rounded-lg p-8">
                <div className="text-center pb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-teal-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
